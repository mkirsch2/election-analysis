...
with open(file_to_save, "w") as txt_file:
    ...
    for county_name in county_votes:
        ...
        if (votes2 > winning_county_count) and (vote2_percentage > winning_county_percentage):
            # If true, then set the winning_county_count = votes2
            # and winning_county_percentage = vote2percentage.
